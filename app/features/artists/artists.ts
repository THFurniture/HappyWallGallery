...
export const artists: Artist[] = [
  ...
  },
  {
    ...
    works: collection("RONAN ART", "Ronan Boyle", [
      ...
      "ronan-gold-black-thicket.png",
      "ronan-aqua-storm-break.png",
      "ronan-gold-diptych-surge.png",
      "ronan-yellow-grey-gradient.png",
      "ronan-green-black-current.png",
      "ronan-warm-grey-horizon.png",
      "ronan-soft-mountain-haze.png",
      "ronan-turquoise-gold-strata.png",
      "ronan-blue-gold-wave.png",
      "ronan-green-foam-field.png",
      "ronan-black-gold-vertical.png",
      "ronan-charcoal-gold-vertical.png",
    ]),
  },
];
